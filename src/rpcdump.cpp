...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"bitcoin2address\"\n"
            "\nEncrypts a private key corresponding to 'bitcoin2address'.\n"
            "\nArguments:\n"
            "1. \"bitcoin2address\"   (string, required) The bitcoin2 address for the private key (you must hold the key already)\n"
