...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Bitcoin 2 address (e.g. %1)").arg("1Q5xbU2mPM6qV8oX83jTBDjoaDTHuQX4wJ"));
#endif
...
{
    // return if URI is not valid or is no Bitcoin2: URI
...
{
    // Convert bitcoin2:// to bitcoin2:
    //
    //    Cannot handle this later, because bitcoin2:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open bitcoin2.conf with the associated application */
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a bitcoin2.desktop file to the autostart directory:
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the bitcoin2 app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add bitcoin2 app to startup item list
