...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoin 2 Core"),
     ...
     * override -datadir in the bitcoin2.conf file in the default data directory
     * (to be consistent with bitcoin2d behavior)
     */
    if (dataDir != getDefaultDataDirectory())
