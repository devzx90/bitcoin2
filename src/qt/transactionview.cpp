 ...
 */
    ...
    typeWidget->addItem(tr("Received BTC2 from zBTC2"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBTC2"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBTC2));
