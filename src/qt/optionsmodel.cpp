...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeBitcoin2Amount"))
        settings.setValue("nAnonymizeBitcoin2Amount", 1000);

    nAnonymizeBitcoin2Amount = settings.value("nAnonymizeBitcoin2Amount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitcoin2Amount"))
        SoftSetArg("-anonymizebitcoin2amount", settings.value("nAnonymizeBitcoin2Amount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitcoin2.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeBitcoin2Amount:
            return QVariant(nAnonymizeBitcoin2Amount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeBitcoin2Amount:
            nAnonymizeBitcoin2Amount = value.toInt();
            settings.setValue("nAnonymizeBitcoin2Amount", nAnonymizeBitcoin2Amount);
            emit anonymizeBitcoin2AmountChanged(nAnonymizeBitcoin2Amount);
            break;
        case CoinControlFeatures:
