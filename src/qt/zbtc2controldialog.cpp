...
#include "ui_zbtc2controldialog.h"
...
std::list<std::string> ZBTC2ControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZBTC2ControlDialog::listMints;

ZBTC2ControlDialog::ZBTC2ControlDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ZBTC2ControlDialog),
    model(0)
{
    ui->setupUi(this);
    listMints.clear();
...
ZBTC2ControlDialog::~ZBTC2ControlDialog()
{
    delete ui;
}

void ZBTC2ControlDialog::setModel(WalletModel *model)
{
    this->model = model;
    updateList();
}
...
void ZBTC2ControlDialog::updateList()
{
...
void ZBTC2ControlDialog::updateSelection(QTreeWidgetItem* item, int column)
{
...
void ZBTC2ControlDialog::updateLabels()
{
    int64_t nAmount = 0;
    for (const CZerocoinMint mint : listMints) {
    ...
    privacyDialog->setZBTC2ControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZBTC2ControlDialog::GetSelectedMints()
{
...
void ZBTC2ControlDialog::ButtonAllClicked()
{
    ui->treeWidget->blockSignals(true);
