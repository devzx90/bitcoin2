...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitcoin2 features */
        {"bitcoin2", "masternode", &masternode, true, true, false},
        {"bitcoin2", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoin2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoin2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoin2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoin2", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoin2", "startmasternode", &startmasternode, true, true, false},
        {"bitcoin2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoin2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoin2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoin2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoin2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoin2", "getmasternodescores", &getmasternodescores, true, true, false},
