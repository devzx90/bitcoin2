...
//translation from bitcoin2 quantity to zerocoin denomination
BOOST_AUTO_TEST_CASE(amount_to_denomination_test)
{
    ...
    BOOST_CHECK_MESSAGE(AmountToZerocoinDenomination(amount) == ZQ_FIVECENTS, "For COIN denomination should be ZQ_FIVECENTS");

    //valid amount (max edge)
    CAmount amount1 = 5000 * COIN;
    BOOST_CHECK_MESSAGE(AmountToZerocoinDenomination(amount1) == ZQ_TWO_THOUSAND, "For 5000*COIN denomination should be ZQ_FIVECENTS");
...
BOOST_AUTO_TEST_CASE(denomination_to_value_test)
{
    ...
    CoinDenomination denomination = ZQ_FIVECENTS;
...
BOOST_AUTO_TEST_CASE(zerocoin_spend_test241)
{
    ...
    CAmount OneCoinAmount = ZerocoinDenominationToAmount(ZQ_FIVECENTS);
