...
/** 
    ...
    ****Note - for Bitcoin2 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of bitcoin2 coming in to a transaction
    ...
    bool HaveInputs(const CTransaction& tx, int Hcheck = 0) const;
