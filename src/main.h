...
static const unsigned int MAX_ZEROCOIN_TX_SIZE = MAX_STANDARD_TX_SIZE; // currently MAX_ZEROCOIN_TX_SIZE is used for normal transaction size limits too.
...
static const unsigned int MAX_TX_SIGOPS_CURRENT = MAX_BLOCK_SIGOPS_CURRENT / 2;
static const unsigned int MAX_TX_SIGOPS_LEGACY = MAX_BLOCK_SIGOPS_LEGACY / 2;
...
static const int MAX_BLOCKS_IN_TRANSIT_PER_PEER = 44; // was 16 in PIVX but that's annoyingly slower.
...
// extern std::set<std::pair<COutPoint, unsigned int> > setStakeSeen; unused
