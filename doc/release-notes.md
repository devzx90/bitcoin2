...
[
  {
    ...
    winner: {
        address: addr,    (string) Bitcoin2 MN Address,
...
- #195 `aee05fe` [ZMQ] ZMQ integration for Bitcoin2 (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with Bitcoin2 (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/bitcoin2-project-translations/).
