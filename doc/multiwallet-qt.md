...
In order to support loading of multiple wallets in bitcoin2-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoin2.cpp.
...
Changes to bitcoin2.cpp
----------------------
bitcoin2.cpp is the entry point into bitcoin2-qt, and as such, will require some minor modifications to provide hooks for
