...
Bitcoin2 now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<bitcoin2_address\> \<monthly_payment_bitcoin2\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Bitcoin2, _12_ times over the course of a year totaling _24000_ Bitcoin2.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<bitcoin2_address\> \<monthly_payment_bitcoin2\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Bitcoin2.
 ...
 * vote-many          - Vote on a Bitcoin2 initiative
 * vote-alias         - Vote on a Bitcoin2 initiative
 * vote               - Vote on a Bitcoin2 initiative/budget
