...
This mechanism has been integrated into Bitcore-Node-Bitcoin2 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Bitcoin2-Project/insight-api-bitcoin2#web-socket-api](https://github.com/Bitcoin2-Project/insight-api-bitcoin2#web-socket-api) 
* API: [https://github.com/Bitcoin2-Project/insight-api-bitcoin2#swifttx-transactions](https://github.com/Bitcoin2-Project/insight-api-bitcoin2#swifttx-transactions) 
...
By default, the Bitcoin 2 Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitcoin 2 Core daemon:
