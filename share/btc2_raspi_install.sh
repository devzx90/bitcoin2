...
cd /usr/local/bin
sudo wget https://github.com/BITC2/bitcoin2/releases/download/2.3/bitcoin2-2.3.0-arm-linux-gnueabihf.tar.gz
echo ""
echo -e "\e[92mDone...\e[0m"
sleep 1
...
echo -e "################################################################################\e[0m"
echo ""
sudo tar -zxvf bitcoin2-2.3.0-arm-linux-gnueabihf.tar.gz
