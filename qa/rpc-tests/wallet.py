...
#   c) node1 mines 32 blocks, so now node 0 has 60001btc2, node 1 has 4250btc2, node2 has none.
#   d) node0 sends 601 btc2 to node2, in two transactions (301 btc2, then 300 btc2).
